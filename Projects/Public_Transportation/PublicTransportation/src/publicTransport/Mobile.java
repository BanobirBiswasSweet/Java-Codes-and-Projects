...
public class Mobile implements ActionListener {
	...
	public void showWindow(){
		...
		frame.add(cancel);
		cancel.setBounds(150, 600, 400, 50);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==confirm){
			...
			t.showWindow(line);
			frame.dispose();
			JOptionPane.showMessageDialog(null,"Mr. X,your ticket is reserved.Reservation confirmation SMS has been "+"\n"
					     + "sent to 018222222.Pay for your ticket with "+line+" to our Merchant Account No:01782345621 and"+"\n"
					     + " confirm your transaction ID below within 60 minutes."+"\n"+"TOTAL AMOUNT: ");
