...
public class Payment implements ActionListener {
	...
	public void showWindow(){
		...
		window.add(new JLabel("Total Amount to pay : "));
		window.add(amount);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==mobile){
			...
			c.showWindow();
			window.dispose();
			JOptionPane.showMessageDialog(null,"Your ticket would be reserved and inactive till "+"\n"
					   + "our call center agent call you and verify your credentials.Tickets would become "+"\n"
					   + "active when you pay the due amount during the delivery of ticket at your doorstep.");
			
		}
		else if(e.getSource()==card){
			window.dispose();
			JOptionPane.showMessageDialog(null, "You would be redirected to a third party payment gateway where "+"\n"
					    + " you can pay with your credit or debit cards.Your payment transaction are 100% secure.On"+"\n"
